...
class SampleBase(object):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("-m", "--led-gpio-mapping", help="Hardware Mapping: regular, adafruit-hat, adafruit-hat-pwm" , default='classic-pi1', choices=['classic-pi1', 'regular', 'adafruit-hat', 'adafruit-hat-pwm'], type=str)
    ...
    def process(self):
        ...
        if self.args.led_no_hardware_pulse:
          options.disable_hardware_pulsing = False # changed for our 32x32 matrix
